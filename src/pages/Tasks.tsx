...
export default function Tasks() {
  ...
  const filtered = useMemo(() => {
    ...
    if (priFilter !== "all")
      list = list.filter((t) => t.priority === priFilter);
    if (catFilter !== "all")
                ...
                {filtered.map((t) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() => toggle(t.id)}
                      aria-label={
                        isTaskDone(t) ? "Mark incomplete" : "Mark complete"
                      }
                      className={cn(
                    ...
                    <div className="min-w-0 flex-1">
                      <p
                        className={cn(
                          ...
                          isTaskDone(t) && "text-muted-foreground line-through",
                        )}
                      >
                        {t.title}
                      </p>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Shows every day and resets each morning. Appears once in All
                tasks.
              </p>
            </div>
          </div>
